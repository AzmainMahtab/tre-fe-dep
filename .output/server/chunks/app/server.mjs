import { version, unref, inject, hasInjectionContext, defineComponent, h, computed, ref, provide, shallowReactive, Suspense, nextTick, Transition, getCurrentInstance, mergeProps, useSSRContext, createApp, effectScope, reactive, watch, isRef, isReactive, toRaw, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, getCurrentScope, onScopeDispose, shallowRef, isReadonly, markRaw, toRefs, isShallow, withCtx } from 'vue';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/checking-8707b0a1.mjs').then((m) => m.default || m)
  },
  {
    name: "customer-id",
    path: "/customer/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_id_-697592c2.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/create-e9cfb28d.mjs').then((m) => m.default || m)
  },
  {
    name: "customer",
    path: "/customer",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0b3771aa.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-1fc276ec.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/login-35f8e0c6.mjs').then((m) => m.default || m)
  },
  {
    name: "lol",
    path: "/lol",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/lol-dc77a877.mjs').then((m) => m.default || m)
  },
  {
    name: "lol2",
    path: "/lol2",
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth-398f2b04.mjs')
};
...
const layouts = {
  default: () => import('./_nuxt/default-52041fba.mjs').then((m) => m.default || m),
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, createError as c, useToken as d, entry$1 as default, useRoute as e, defineNuxtRouteMiddleware as f, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
